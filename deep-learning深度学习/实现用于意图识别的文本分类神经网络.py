...
# In[2]:
# https://mp.weixin.qq.com/s/xQY8UAjE6kLPQ7eHPJLgbw
...
# 我们的训练数据中，12个句子分别属于3类意图（intent）：greeting、goodbye和sandwich：
...
# 现在我们进行数据预处理：
# 请注意，每个单词都转换为小写并进行了词干提取。 词干提取可以帮助机器理解have和having是一样的。 另外，我们也不关心单词的大小写。
...
# 26 unique stemmed words ['for', 'good', 'talk', 'hav', 'soon', 'can', 'day', 'is', 'sandwich', 'ar', 'yo', 'see', 'lunch', "'s", 'to', 'mak', 'going', 'a', 'how', 'nic', 'what', 'you', 'today', 'me', 'it', 'lat']
