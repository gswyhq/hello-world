...
# gswyhq@gswyhq-PC:~$ curl 'https://videos8.jsyunbf.com/20190606/xp8D5cWd/index.m3u8'

# 直接下载这个链接，会得到一个.m3u8的文件，内容如下：
# #EXTM3U
# #EXT-X-STREAM-INF:PROGRAM-ID=1,BANDWIDTH=1000000,RESOLUTION=1280x536
# /20190606/xp8D5cWd/1000kb/hls/index.m3u8
#
# m3u8链接分层的，所以还需要解析，最后一行的 /20190606/xp8D5cWd/1000kb/hls/index.m3u8 其实是获取第二层KEY。
# 即要用它替换掉之前解析出来的链接的最后的"index.m3u8"，构成新的链接。
#
# gswyhq@gswyhq-PC:~$ curl 'https://videos8.jsyunbf.com/20190606/xp8D5cWd/1000kb/hls/index.m3u8'
...
# #EXTINF:5,
# /20190606/xp8D5cWd/1000kb/hls/ymGV3236000.ts
# #EXTINF:5.88,
# /20190606/xp8D5cWd/1000kb/hls/ymGV3236001.ts
# #EXTINF:5.92,
# /20190606/xp8D5cWd/1000kb/hls/ymGV3236002.ts
# ....
# /20190606/xp8D5cWd/1000kb/hls/ymGV3236229.ts
# #EXTINF:2.16,
# /20190606/xp8D5cWd/1000kb/hls/ymGV3236230.ts
# #EXT-X-ENDLIST
...
# ts合并成mp4
# 整合所有ts文件，保存为mp4格式
def tsToMp4(download_path):
    print("开始合并...")
    # os.system("copy /b {}/*.ts new.mp4".format(download_path))  # widows 系统
    os.system('cat {}/*.ts > new.mp4'.format(download_path)) # linux 系统
    print("结束合并...")

def main():
    url_root = 'https://videos8.jsyunbf.com'
    m3u8_url_2 = 'https://videos8.jsyunbf.com/20190606/xp8D5cWd/1000kb/hls/index.m3u8'
