...
# 加载数据集
data = load_data([
    rf'D:/Users/{USERNAME}/data/sentiment/sentiment.train.data',
    rf'D:/Users/{USERNAME}/data/sentiment/sentiment.valid.data',
    rf'D:/Users/{USERNAME}/data/sentiment/sentiment.test.data',
])
