...
# 计算两个句子的WMD距离：
w2v_model.wmdistance(['重疾险', '如何', '赔付'], ['重疾险', '的', '赔付', '方式'])

# 计算两个词的余弦相似度：
w2v_model.n_similarity('北京', '北京市')
# Out[22]: 0.92623079478998527
# w2v_model.n_similarity('北京', '上海市')
# Out[23]: 0.49459310153199754
# w2v_model.n_similarity('北京', '燕京')
# Out[24]: 0.87067554956650683
