#!/bin/bash
# 用于执行Apoc expor cypher测试的脚本
# https://raw.githubusercontent.com/neo4j-contrib/neo4j-apoc-procedures/3.4/docs/script/performanceCypherTest.sh
# https://github.com/neo4j-contrib/neo4j-apoc-procedures/blob/3.4/docs/script/performanceCypherTest.sh
