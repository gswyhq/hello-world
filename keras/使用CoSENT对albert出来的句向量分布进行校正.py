...
#
# # git clone https://github.com/TinkerMob/keras_albert_model.git
# # cd keras_albert_model
...
#
# model_dir = rf"D:\Users\{USERNAME}\data\albert_tiny_489k"
# model_ckpt = os.path.join(model_dir, "albert_model.ckpt")
# config_file = os.path.join(model_dir, "albert_config_tiny.json")
...
# # https://copyfuture.com/blogs-details/20211205124449540e
# #
# # albert_tiny_zh(训练更久，累积学习20亿个样本)，文件大小16M、参数为4M
#
# # 构建模型
# import json
# import codecs
...
# import keras
# def create_cls_model(num_labels, model_dir=model_dir):
#     albert_model = load_brightmart_albert_zh_checkpoint(model_dir, training=False)
#
...
# output = keras.layers.Lambda(lambda x: K.mean(x, axis=1))(albert_model.get_layer(
#             'Feed-Forward-Add-4').output)
# encoder = keras.models.Model(albert_model.inputs, output)
# model = encoder
...
#
# save_h5_file = r'D:\Users\{}\data\SimCSE-bert-base\My_CoSENT_albert.h5'.format(os.getenv("USERNAME"))
