...
# 使用VisionTransformer(ViT)模型进行图像分类
...
# cd ~/.keras/datasets && mv cifar-10-python.tar.gz cifar-10-batches-py.tar.gz
...
for i, patch in enumerate(patches[0]):
    ...
    patch_img = K.reshape(patch, (patch_size, patch_size, 3))
...
# 资料来源：https://keras.io/examples/vision/image_classification_with_vision_transformer/
