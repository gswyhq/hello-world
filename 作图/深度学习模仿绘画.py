...
# https://baijiahao.baidu.com/s?id=1588917178856274332&wfr=spider&for=pc
# https://github.com/andersbll/neural_artistic_style
# https://github.com/llSourcell/How-to-Generate-Art-Demo/blob/master/demo.ipynb

#  2003  sudo pip3 install Keras==1.2.2 -i http://pypi.douban.com/simple --trusted-host=pypi.douban.com
#  2004  sudo pip3 install tensorflow==1.0.0 -i http://pypi.douban.com/simple --trusted-host=pypi.douban.com
#  2005  sudo pip3 install Pillow==4.0.0 -i http://pypi.douban.com/simple --trusted-host=pypi.douban.com
#  2006  sudo pip3 install h5py==2.6.0 -i http://pypi.douban.com/simple --trusted-host=pypi.douban.com
...
content_image_path = '/home/gswyhq/github_projects/How-to-Generate-Art-Demo/images/hugo.jpg'
...
style_image_path = '/home/gswyhq/github_projects/How-to-Generate-Art-Demo/images/styles/wave.jpg'
...
img3 = Image.fromarray(x)
img3.show()
img3.save('/home/gswyhq/github_projects/How-to-Generate-Art-Demo/images/hugo_save.jpg')
